                    ...
                    <table class="table table-striped project-orders-table table-layout-fixed text-wrap">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%;">Name Media Sosial</th>
                                <th style="width: 15%;">Name Account</th>
                                <th style="width: 20%;">Link</th>
                                <th style="width: 20%;">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($medias as $hero)
                                <tr>
                            ...
                            <tr>
                                <td colspan="10" class="text-center">
                                    <a href="{{ route('admin.media.create') }}" class="btn btn-success btn-icon-text">
...
document.querySelectorAll('.toggle-status').forEach((el) => {
    el.addEventListener('change', function() {
        ...
        fetch("{{ route('admin.media.toggle') }}", {
            method: "POST",
            headers: {
