                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center mb-2">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('admin.history.edit', $hero->id) }}"
                                                class="btn btn-success btn-sm d-flex align-items-center mr-2">
                                                Edit <i class="typcn typcn-edit ml-1"></i>
                                            </a>

                                            {{-- Tombol Delete --}}
                                            <form action="{{ route('admin.history.destroy', $hero->id) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="text-center">
                                    <a href="{{ route('admin.history.create') }}" class="btn btn-success btn-icon-text">
...
document.querySelectorAll('.toggle-status').forEach((el) => {
    el.addEventListener('change', function() {
        ...
        fetch("{{ route('admin.history.toggle') }}", {
            method: "POST",
            headers: {
