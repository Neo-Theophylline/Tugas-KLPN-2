                    ...
                    <table class="table table-striped project-orders-table table-layout-fixed text-wrap">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 20%;">Pre-Description</th>
                                <th style="width: 20%;">Description</th>
                                <th style="width: 20%;">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($abouts as $hero)
                                <tr>
                            ...
                            <tr>
                                <td colspan="10" class="text-center">
                                    <a href="{{ route('admin.about.create') }}" class="btn btn-success btn-icon-text">
...
document.querySelectorAll('.toggle-status').forEach((el) => {
    el.addEventListener('change', function() {
        ...
        fetch("{{ route('admin.about.toggle') }}", {
            method: "POST",
            headers: {
